...
.nav-top.collapsed .nav-top-left{width:80px;padding:0}\
...
.nav.collapsed .nav-sec-bd{max-height:1000px!important}\
.nav.collapsed .nav-sec-bd .nav-link{padding-left:24px}\
