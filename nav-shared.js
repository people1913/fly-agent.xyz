/**
 * Fly 官网共享侧边栏 v27 · 产品优先架构
 * 重构：只改文字，框架不变
 * 5组结构保持不变，文字从信任系统改为归因系统
...
{id:'identity',label:'Revenue Flow 收入流',color:'#1A3D2E',defaultOpen:true,icon:'<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>',
links:[
